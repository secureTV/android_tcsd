...
struct tcsd_config
{
	...
	char *permission_ps_file;/* the name of the permission system PS file*/
#endif
};
...
#define TCSD_DEFAULT_SYSTEM_PS_FILE	"/data/tpm/system.data"	// VAR_PREFIX "/lib/tpm/system.data"
#define TCSD_DEFAULT_SYSTEM_PS_DIR	"/data/tpm"	// VAR_PREFIX "/lib/tpm"
#define TCSD_CREDENTIAL_FILE	"/data/tpm/credential"
...
#define TCSD_DEFAULT_PERMISSION_PS_FILE	"/data/tpm/permission.data" 
...
#ifdef NATIVE_SERVICE
#define TCSD_OPTION_PERMISSION_PSFILE 0x2000
#endif
