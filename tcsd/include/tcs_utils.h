...
TSS_RESULT TCSP_FlushSpecific_Common(UINT32, TPM_RESOURCE_TYPE);
	...
	TSS_RESULT TCS_SetCredential_Internal(TCS_CONTEXT_HANDLE hContext,	/* in  */
					      UINT32 ulCredentialType,		/* in */
					      UINT32 ulCredentialAccessMode,	/* in */
					      UINT32 ulCredentialSize,	/* in */
					      BYTE * rgbCredentialData	/* in */
	);
	...
	TSS_RESULT tcsi_AC_GetPermissionList_Internal(TCS_CONTEXT_HANDLE hContext,	/* in */
	...
	TSS_RESULT tcsi_AC_SetPermissionList_Internal(TCS_CONTEXT_HANDLE hContext,	/* in */
			 TSS_UUID KeyUUID,	/* in */
			 UINT32 UID,		/* in */
	...
	TSS_RESULT tcsi_AC_CheckStatus_Internal(TCS_CONTEXT_HANDLE hContext,	/* in */
