...
DECLARE_TCSTP_FUNC(SetCredential);
#else
#define tcs_wrap_GetCredential		tcs_wrap_Error
#define tcs_wrap_SetCredential		tcs_wrap_Error
#endif
#else
...
DECLARE_TCSTP_FUNC(AC_GetPermissionList);
DECLARE_TCSTP_FUNC(AC_SetPermissionList);
DECLARE_TCSTP_FUNC(AC_CheckStatus);
#else
#define tcs_wrap_AC_GetPermissionList 	tcs_wrap_Error
#define tcs_wrap_AC_SetPermissionList		tcs_wrap_Error
#define tcs_wrap_AC_CheckStatus		tcs_wrap_Error
#endif
